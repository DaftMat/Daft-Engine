...
void
Log::init (const std::string &engineLoggerName,
           const std::string &appLoggerName)
{
...
#endif
  m_engineLogger = spdlog::basic_logger_mt (
      engineLoggerName, "logs/" + engineLoggerName + ".txt");
  m_appLogger = spdlog::basic_logger_mt (appLoggerName,
                                         "logs/" + appLoggerName + ".txt");
