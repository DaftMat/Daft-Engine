...
void
ShaderProgram::setMat2 (const std::string &name, const glm::mat2 &value) const
{
...
void
ShaderProgram::setMat3 (const std::string &name, const glm::mat3 &value) const
{
...
void
ShaderProgram::setMat4 (const std::string &name, const glm::mat4 &value) const
{
...
void
ShaderProgram::checkCompileError (GLuint shader, const std::string &type)
{
  int success;
  char infoLog[1024];
...
void
ShaderProgram::checkLinkError (GLuint program)
{
  int success;
  char infoLog[1024];
